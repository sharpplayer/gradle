...
public interface TaskDependencyResolveContext {
    ...
    /**
     * Attach an action to run as soon as the given task completes.
     *
     * <p>This should evolve into some mechanism to add a real node to the graph with the same behaviour, but as a first step this is simply bolted on.
     */
